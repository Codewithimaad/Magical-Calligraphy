...
const Dashboard = () => {
  const stats = [
    ...
    { name: 'Active Courses', value: '12', change: '+2', changeType: 'positive' },
  ];

  const recentOrders = [
    { id: 1, customer: 'Ahmed Khan', product: 'Handwriting Mastery Kit', amount: '₨1,499', status: 'Completed' },
    { id: 2, customer: 'Fatima Ali', product: 'Printable Worksheets', amount: '₨1,000', status: 'Pending' },
    { id: 3, customer: 'Muhammad Hassan', product: 'Complete Package', amount: '₨2,499', status: 'Processing' },
    { id: 4, customer: 'Ayesha Malik', product: 'WhatsApp Coaching', amount: '₨1,000', status: 'Completed' },
  ];
