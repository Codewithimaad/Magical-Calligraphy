const CallToAction = () => {
    return (
        <section className="relative py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 overflow-hidden 0">


            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Main CTA Container - Responsive padding */}
                <div className="backdrop-blur-xl bg-white/80 dark:bg-gray-800/80 border border-white/30 dark:border-gray-700/50 rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-2xl text-center">
                    {/* Urgency Indicator */}
                    <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-300/30 rounded-full px-3 py-1 sm:px-4 sm:py-2 mb-6 sm:mb-8">
                        ...
                        <span className="text-orange-700 dark:text-orange-300 font-semibold text-xs sm:text-sm">Limited Time Offer</span>
                    </div>

                    {/* Main Heading - Responsive font sizes */}
                    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
                        <span className="bg-gradient-to-r from-gray-800 via-gray-700 to-gray-900 dark:from-gray-100 dark:via-gray-300 dark:to-gray-100 bg-clip-text text-transparent">
                            Start Learning
                        </span>
                        <br />
                    ...
                    <div className="mb-8 sm:mb-10">
                        <div className="backdrop-blur-lg bg-white/50 dark:bg-gray-700/50 border border-white/30 dark:border-gray-600/50 rounded-2xl p-6 sm:p-8 inline-block shadow-xl">
                            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                                <div className="text-center">
                                    <div className="flex items-baseline justify-center space-x-2 mb-1 sm:mb-2">
                                        <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 dark:text-white">Rs 1,500</span>
                                        <span className="text-base sm:text-lg text-gray-600 dark:text-gray-300 line-through">Rs 5,000</span>
                                    </div>
                                    <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 font-medium">70% OFF</div>
                                </div>
                                <div className="w-full sm:w-px h-px sm:h-16 bg-gray-300 dark:bg-gray-600"></div>
                                <div className="text-center">
                                    <div className="flex items-center justify-center space-x-2 mb-1 sm:mb-2">
                                        ...
                                        <span className="text-base sm:text-lg font-bold text-gray-800 dark:text-white">Lifetime Access</span>
                                    </div>
                                    <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">Never expires</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-8 sm:mb-10">
                        {[
                            ...
                            <div key={index} className="flex items-center justify-center space-x-2 p-3 sm:p-4 backdrop-blur-lg bg-white/50 dark:bg-gray-700/50 border border-white/30 dark:border-gray-600/50 rounded-lg sm:rounded-xl">
                                ...
                                <span className="text-sm sm:text-base font-semibold text-gray-700 dark:text-gray-200">{item.text}</span>
                            </div>
                        ))}
                    </div>
